...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    GDTabBarController *rootVC = [GDTabBarController tabBarControllerWithAddChildVCsBlock:^(GDTabBarController *tabBarC) {
        [tabBarC addChildVC:[GDTestViewController new] normalImageName:@"tabbar_find_n" selectedImageName:@"tabbar_find_h" isRequiredNavController:YES];
    ...
    GDTabBar *tabbar = (GDTabBar *)rootVC.tabBar;
